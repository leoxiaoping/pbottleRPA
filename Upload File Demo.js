...
pbottleRPA.openURL('https://www.google.com/imghp?hl=en&ogbl')
...
pbottleRPA.browserCMD_click('div.etxtjc')
pbottleRPA.wait(2)
                           // Wait for the dialog to open

// Copy the file to be uploaded to the clipboard
pbottleRPA.copyFile(pbottleRPA.path.resolve('./input/RPAlogo128.png'))
...
// Confirm the upload
pbottleRPA.wait()                             // Wait for the upload to process
pbottleRPA.paste('RPA')
