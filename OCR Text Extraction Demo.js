...
console.log('Screen OCR result:', pbottleRPA.aiOcr('screen', 0, 0, 500, 500)) // Perform OCR on the top‑left area of the screen (0,0,500,500) and output the result
...
console.log("Searching for and clicking pbottleRPA") // Output the operation info to the console
pbottleRPA.tts("Searching for and clicking pbottleRPA") // Announce the upcoming operation

let position = pbottleRPA.findText('RPA', 100, 100, 500, 1080) // Search for the text "WeChat" within the screen area, returning the position
...
if (position) {                                // If the specified text is found
    ...
    console.log("Text 'RPA' not found in the specified area."); // Output a hint that the text was not found
}
...
position = pbottleRPA.waitText('Download', 300, 500)  // Wait for the text to appear
console.log(position);
pbottleRPA.moveAndClick(position.x, position.y) // Move the mouse to the text position