...
pbottleRPA.log("=== 运维消息通知测试 ===");                  # 在控制台输出测试标题
pbottleRPA.log("当前时间：",pbottleRPA.getTime());          # 在控制台输出当前日期时间  
...
apiUrl = 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=67bc3b43-85d1-4e0b-b7a2-d8c22d415a80'; # 企业微信机器人的Webhook地址

# 使用POST请求发送JSON格式消息到指定API地址
rs = pbottleRPA.postJson(apiUrl,msgJson);
pbottleRPA.log('服务器返回结果：',rs);
